        ...
        <table class="min-w-full bg-gray-800 border border-gray-700 shadow-md rounded-lg mt-5">
          ...
          <tbody class="text-gray-300">
              ...
              <tr class="border-b border-gray-700 hover:bg-gray-700">
                  ...
                  <a href="/user/my-jobs/edit/{{ $job->slug }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-green-600 rounded hover:bg-green-500 transition-colors">
